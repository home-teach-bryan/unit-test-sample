...
public class Student2FluentTests
{
    [Test]
    public void Student2FluentTests_CompareTwoStudent()
    {
        // Arrange
    ...
    [Test]
    public void Student2FluentTests_CompareTwoStudents_WithOrder()
    {
        // Arrange
    ...
    [Test]
    public void Student2FluentTests_CompareTwoStudents_WithAnyOrder()
    {
        // Arrange
        var expected = new List<Student2>
        {
